...
public class UpdateItemTodoNullDescription : IClassFixture<CustomWebApplicationFactory<Startup>>, IAsyncLifetime

{
    ...
    public UpdateItemTodoNullDescription(CustomWebApplicationFactory<Startup> factory)
    {
